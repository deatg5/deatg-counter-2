...
contextBridge.exposeInMainWorld('electron', {
  ...
  onDiscordStatusUpdate: (callback: (status: DiscordStatus) => void) => ipcRenderer.on('discord-status-update', (_, data) => callback(data)),
...
declare global {
  interface Window {
    electron: {
      ...
      onDiscordStatusUpdate: (callback: (status: DiscordStatus) => void) => void;
